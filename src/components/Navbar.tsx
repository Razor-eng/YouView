...
export default function Navbar() {
  ...
  return (
    <div className="flex justify-between items-center  px-14 h-14 bg-[#212121] opacity-95 sticky top-0 z-50">
      ...
      <div className="flex justify-start sm:items-center sm:justify-center gap-5">
        <form
          onSubmit={(e) => {
            e.preventDefault();
            handleSearch();
        ...
        >
          <div className="flex bg-zinc-900 items-center h-10 px-4 pr-0">
            <div className="flex gap-4 items-center pr-5">
              ...
              <input
                type="text"
                className="sm:w-96 w-full bg-zinc-900 focus:outline-none border-none"
                placeholder="search"
                value={searchTerm}
            ...
            <button className="md:h-10 md:w-16 md:flex md:items-center md:justify-center md:bg-zinc-800 hidden">
              <AiOutlineSearch className="text-xl" />
            </button>
          </div>
        </form>
      ...
      <div className="lg:flex lg:gap-5 lg:items-center lg:text-xl hidden">
        <BsCameraVideo />
        <IoAppsSharp />
